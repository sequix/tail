...
See [API documentation](http://godoc.org/github.com/sequix/tail).
...
## Installing
    ...
    go get github.com/sequix/tail/...

## Windows support

This package [needs assistance](https://github.com/sequix/tail/labels/Windows) for full Windows support.
